          ...
          >Receive Updates</motion.h3>
            <div className="wrapper md:text-center">
              ...
              <div>
                ...
                <input type="text" placeholder='Enter Your Email Address' className='md:w-[50%] w-[100%]
                 py-[20px] px-6 md:rounded-2xl rounded-md outline-none placeholder:pl-3 md:placeholder:text-[18px] placeholder:text-[14px]'/>
                 <Link><button className=' btn md:absolute md:left-[960px] left-[210px] md:top-[8px] top-[7px] md:bottom-[8px] bottom-[7px] 
                  md:px-11  md:text-[18px] md:mt-0
                  z-[9999] xs:px-3 md:py-2 md:rounded-2xl xs:text-[16px]
                  md:w-auto w-full  mt-5 rounded-md
